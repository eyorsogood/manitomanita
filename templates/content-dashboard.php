                    ...
                    <div class="dashboard__gd">
                        ...
                        <div class="row metrics">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="bigger"><?php echo ($u)?count($u):'0'; ?></div>
                            </div>
                            <div class="col-md-3">
                                <h2>WISH<span>LISTS</span></h2>
                                <div class="bigger"><?php echo $users->getWishlistCount($group->getGroupId()); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="body-dash">
                            ...
                            <?php if($u): ?>
                                ...
                                <div class="card">
                                    ...
                                    <h2 class="mb-0">
                                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse<?php echo $k; ?>" aria-expanded="false" aria-controls="collapse<?php echo $k; ?>">
                                        <i class="fas fa-chevron-circle-right"></i> <?php echo get_field('screen_name', $user->ID); ?>
                                        </button>
                                        <div class="action-btns">
                                            <a href="#" class="expand-deets"><i class="fas fa-stream"></i> Expand Details</a>
                                            <a href="#" class="user-action comment-btn" user-data="<?php echo $user->ID; ?>"><i class="far fa-comment"></i> Comment Member</a>
                                        </div>
                                        
                                    </h2>
                                    </div>

                                    <div id="collapse<?php echo $k; ?>" class="collapse" aria-labelledby="heading<?php echo $k; ?>" data-parent="#members-list">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h2>Wish<span>List</span></h2>
                                                <ul class="wishlist-list">
                                                    <?php 
                                                        $wishlist = get_field('my_wishlists', $user->ID);
                                                        
                                                        if(!$wishlist){
                                                            echo '<div class="placeholder"><i class="fas fa-gifts"></i> No wishlist provided yet.</div>';
                                                        }
                                                    ...
                                                    <li>
                                                        <div class="wish-content"><?php echo $w['wishlist_description'];?></div>
                                                        <div class="wish-links">
                                                            <?php 
                                                                if($w['reference_links']):
                                                                    foreach($w['reference_links'] as $k => $links):
                                                                        // Test if string contains the word 
                                                                        $stringlink = (strpos($links['link_url'], 'lazada.com.ph') !== false)?'https://invol.co/aff_m?offer_id=101165&aff_id=189674&source=deeplink_generator_v2&property_id=133170&url='.urlencode($links['link_url']):$links['link_url'];
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <ul class="comments-list">
                                                    <?php 
                                                        $comments = get_comments(array('post_id' => $user->ID,'orderby'=>'comment_date',
                                                        'order'=>'ASC'));
                                                        
                                                        if(count($comments) == 0){
                                                            echo '<div class="placeholder"><i class="far fa-comment-dots"></i> Say something for me.</div>';
                                                        }
                                                    ...
                                                    <li>
                                                        <div class="com-content"><?php echo $c->comment_content;?></div>
                                                        <div class="com-date"><?php echo date('F d, Y h:i:sa', strtotime($c->comment_date));?></div>
                                                    </li>
                                    ...
                                    <div class="user-action-btns">
                                        <a href="#" class="user-action wish-btn" user-data="<?php echo $user->ID; ?>" data-action="edit-wishlist"><i class="fas fa-gift"></i> Edit Wishlist</a>
                                        <a href="javascript:;" <?php echo (!get_field('matched', $group->getGroupId()))?'disabled':'class="user-action match-btn" user-data="'.$user->ID.'" data-action="see-match"'; ?>><i class="fas fa-user-friends"></i> See Match</a>
                                        <a href="javascript:;" <?php echo (get_field('matched', $group->getGroupId()))?'disabled':'class="user-action leave-btn" user-data="'.$user->ID.'" data-action="leave-group"'; ?>><i class="fas fa-sign-out-alt"></i> Leave Group</a>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
...
-->        
        ...
        <div class="col-md-12 text-center advertisement" style="padding-top: 35px;">   
            ...
            <a target="_blank" href="https://www.facebook.com/IslaKrayola/"><img style="width: 750px;" src="https://manitomanita.com/wp-content/uploads/2020/12/isla-logo.png"></a>
        </div>
    </div>
</div>
    ...
    <div class="popup__inner">
        ...
        <div class="row">
            <div class="col-md-12 joined card-columns">
                <?php 
                $getusers = $users->getAllUsersPerGroup($group->getGroupId());
                shuffle($getusers); 
                ?>
