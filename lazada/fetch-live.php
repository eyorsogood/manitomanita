...
$data = file_get_contents('/home/eyorlthz/public_html/manitomanita/wp-content/themes/eyor-theme/lazada/assets/lazada.json');
...
function generateShopContents($products){
    ...
    foreach($products as $category){
        ...
        foreach($prod_list as $prod_details){
            ...
            $deeplink = "https://invol.co/aff_m?offer_id=101165&aff_id=189674&source=deeplink_generator_v2"; //involve asia
